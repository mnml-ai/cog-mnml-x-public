...
class Generator:
    def __init__(self, sd_path= "stablediffusionapi/majicmix-v7", vae_path= None, load_ip_adapter=False, load_controlnets={}, use_compel= False, ip_image_encoder= "weights/image_encoder", ip_weight="weights/ip-adapter_sd15.bin" ):
        ...
        self.pipe.load_lora_weights("dsgnrai/lora", weight_name="ext_v1.safetensors", adapter_name="ext_v1")
    ...
    def predict(self, prompt="", lineart_image=None, lineart_conditioning_scale=1.0,
                ...
                mp_lora_weight=0, id_lora_weight=0, ext_v1_lora_weight=0,
        ...
        if id_lora_weight!=0:
            ...
            loras.append("id_v1")
        if ext_v1_lora_weight!=0:
            lora_weights.append(ext_v1_lora_weight)
            loras.append("ext_v1")
